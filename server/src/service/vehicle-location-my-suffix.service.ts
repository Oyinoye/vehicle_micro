...
export class VehicleLocationService {
    ...
    constructor(
        @InjectRepository(VehicleLocationRepository) private vehicleLocationEntityRepository: VehicleLocationRepository,
    ) {}
    ...
    async save(
        vehicleLocationEntityDTO: VehicleLocationDTO,
        creator?: string,
    ): Promise<VehicleLocationDTO | undefined> {
