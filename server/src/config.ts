...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8085';
    'jhipster.clientApp.name' = 'maxVehicle';
    ...
    'jhipster.mail.from' = 'maxVehicle@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'maxVehicle API';
    'jhipster.swagger.description' = 'maxVehicle API documentation';
    ...
    'eureka.instance.appname' = 'maxVehicle';
    'eureka.instance.instanceId' = 'maxVehicle:${random.value}';
